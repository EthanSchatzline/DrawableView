...
SWIFT_CLASS("_TtC12DrawableView12DrawableView")
@interface DrawableView : UIView
@property (nonatomic, readonly) BOOL containsDrawing;
@property (nonatomic) CGFloat strokeWidth;
@property (nonatomic, strong) UIColor * _Nonnull strokeColor;
@property (nonatomic) CGFloat strokeTransparency;
...
@interface DrawableView (SWIFT_EXTENSION(DrawableView))
- (void)undo;
@end
